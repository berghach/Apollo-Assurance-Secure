...
public class HabitationContractDTO extends ContractDTO{
    ...
    public HabitationContractDTO(boolean accepted, BigDecimal amount, LocalDate submittedOn, LocalDate expiredOn, UserDTO client, BigDecimal propertyValue, String type, ZoneDTO zone, String address, String securitySystem) {

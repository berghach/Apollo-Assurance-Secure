...
public class AutoContractDTO extends ContractDTO{
    ...
    public AutoContractDTO(boolean accepted, BigDecimal amount, LocalDate submittedOn, LocalDate expiredOn, UserDTO client, int driverAge, boolean luxurious, boolean professional, boolean damaged, String damageHistory) {

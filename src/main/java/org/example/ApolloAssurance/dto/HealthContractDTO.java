...
public class HealthContractDTO extends ContractDTO{
    ...
    public HealthContractDTO(boolean accepted, BigDecimal amount, LocalDate submittedOn, LocalDate expiredOn, UserDTO client, int insuredAge, String chronicIllness, boolean premium) {
